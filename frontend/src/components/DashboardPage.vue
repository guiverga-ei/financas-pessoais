<template>
    <div class="dashboard-container">
      ...
      <div class="card summary-card">
        <h3>Resumo do Mês</h3>
        <p><strong>Receitas:</strong> <span class="income">{{ dashboardData.monthly_income }}€</span></p>
        <p><strong>Despesas:</strong> <span class="expense">{{ dashboardData.monthly_expense }}€</span></p>
      ...
      <div class="card transactions-card">
        ...
        <ul>
          <li v-for="transaction in dashboardData.latest_transactions" :key="transaction.id">
            {{ transaction.description }} - <span :class="getTransactionClass(transaction.amount)">{{ transaction.amount }}€</span> 
